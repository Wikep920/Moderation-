...
client.on("message", async message => {
 ...
 client.on('message', msg => {
  if (msg.content === prefix+'ping') {
    msg.channel.send(`Pingim **${client.ws.ping}** `)
  }
});
///////////////////////////////
client.on('message', msg => {
...
client.on("ready", () => {
  client.channels.cache.get(`885781801644220447`).join();
});
...
///////////////////////////////
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'neoyu') {
    msg.reply('Mügenin Sevgilisi <3');
  }
});
...
///////////////////////////////
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'papaz') {
    msg.reply('Reis');
  }
});
...
///////////////////////////////
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'müge') {
    msg.reply('Enesin Sevgilisi <3');
  }
});
